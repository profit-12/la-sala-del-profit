...
<section className="max-w-7xl mx-auto px-6 py-20">
  ...
  <div className="grid md:grid-cols-4 gap-8">
    <div className="bg-white/5 border border-white/10 rounded-3xl p-8 text-center hover:scale-105 transition duration-300">
      ...
      <h3 className="text-2xl font-bold">Mario Peña</h3>
    ...
    <div className="bg-white/5 border border-white/10 rounded-3xl p-8 text-center hover:scale-105 transition duration-300">
      <div className="text-6xl mb-4">📊</div>
      <h3 className="text-2xl font-bold">Enzo Pabón</h3>
      <p className="text-green-400 font-semibold mt-2">
        Mentor
      </p>
    </div>
    ...
    <div className="bg-white/5 border border-white/10 rounded-3xl p-8 text-center hover:scale-105 transition duration-300">
      <div className="text-6xl mb-4">💡</div>
      <h3 className="text-2xl font-bold">Zoily</h3>
      <p className="text-green-400 font-semibold mt-2">
        Mentora
      </p>
    </div>
